...
const Create = () => {
    ...
    const setBannerImage = (file: UploadWidgetValue | null, field: { onChange: (v: string) => void }) => {
        if (file) {
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <UploadWidget 
                                                value={field.value ? {url: field.value as string, publicId: (bannerPublicId ?? '') as string} : null}
